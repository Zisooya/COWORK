...
public class MemberMailSendService {
    ...
    public int mailSendWithPassword(String mem_id, String mem_email) {
        ...
        String htmlStr = "<div style=\"width:100%; min-width:690px; height:auto; margin:0; padding:50px 0px; box-sizing:border-box; background:#f4f4f7; font-family: 'Noto Sans KR', sans-serif;\">\n" +
                ...
                "            <a href=\"http://localhost:8090/cowork\" style=\"font-size:15px; font-weight:500; letter-spacing:-0.075em; text-decoration:none; color:#fff; background:#7BE66D; padding:13px 29px 15px; border-radius:50px; display:inline-block; margin:28px 0 0;\" rel=\"noreferrer noopener\">로그인 페이지로 이동하기</a>\n" +
