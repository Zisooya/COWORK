				...
				<div class="min-height-200px">
							...
							<div class="col-md-6 col-sm-12">
								...
								<nav aria-label="breadcrumb" role="navigation">
									<ol class="breadcrumb">
										...
										<li class="breadcrumb-item active" aria-current="page">받은 메일 전달</li>
									</ol>
								</nav>
							</div>
						</div>
					...
					<div class="pd-20 card-box mb-30">
						...
						<form action="" method="post" enctype="multipart/form-data" id="sendDelivery">
							...
							<input type="hidden" name="eml_from" value="${ member.mem_name }">
							...
							<div class="form-group">
								<div class="mailReceiver">
									...
									<br>
										<input class="form-control" value="FW: ${receiveMail.eml_title }" type="text" name="eml_title" required="required" placeholder="메일 제목을 입력해주세요.">
									<br>
									<br>
								</div>
